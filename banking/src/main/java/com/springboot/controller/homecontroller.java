...
public class homecontroller {
	...
	public String dodeposit(@ModelAttribute("amount") String amount,@PathVariable("username") String username,Model m)
	{	System.out.println("depo");
	...
	primay.setAccountBalance(primay.getAccountBalance().add(new BigDecimal(amount)));
		this.pdao.save(primay);
		 Date date = new Date();
	       ...
	       Transactions primaryTransaction = new Transactions( date, "Deposited", "Account", "Finished", new Double(amount), primay.getAccountBalance(), primay);
		...
		primay.setAccountBalance(primay.getAccountBalance().subtract(new BigDecimal(amount)));
			...
			m.addAttribute("username", username);
			 Date date = new Date();
		       ...
		       Transactions primaryTransaction = new Transactions( date, "Withdrawn", "Account", "Finished", new Double(amount), primay.getAccountBalance(), primay);
		        this.usertansc.save(primaryTransaction);
	...
	public String search(@ModelAttribute("gsearch") String name,@PathVariable("username") String username,Model m)
